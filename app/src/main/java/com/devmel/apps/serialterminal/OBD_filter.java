...
/**
 * Created by Kristijonas on 02/11/2016.
 */
public class OBD_filter extends Activity {
    ...
    public static void main(String[] args) {
        ...
        //packetReceived("424C3000C0042D603FF");

        //System.out.println(positionLightsStatus);

    }

    public static String packetReceived(String text) {
        String pid;
        packet = new String[8];
        int pidNo = 0;
    ...
    private static void calculateStateOfCharge(String[] packet) {
        double temp = 0;
        temp = Integer.parseInt(packet[1].trim(), 16) * 0.5 - 5;
        if(temp > 0){
            SOC = temp;
        }
    }
